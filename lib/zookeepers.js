...
function filterByQuery(query, zookeepers) {
    ...
    if (query.age) {
        filteredResults = filteredResults.filter(
            // Since our form data will be coming in as strings, and JSON
            // is storing our age as a number, we must convert the query string
            // to a number to perform a comparison!
